...
class ResultCode(StrEnum):
    ...
    INTERFACE_ATTACHED = "INTERFACE_ATTACHED"
    ...
    PDF_INVALID_RANGE = "PDF_INVALID_RANGE"
    PDF_UNREADABLE = "PDF_UNREADABLE"
    PDF_BUDGET_EXHAUSTED = "PDF_BUDGET_EXHAUSTED"
    PDF_VISUAL_ANSWER = "PDF_VISUAL_ANSWER"
    DISCUSSION_READ = "DISCUSSION_READ"
    DISCUSSION_EMPTY = "DISCUSSION_EMPTY"
