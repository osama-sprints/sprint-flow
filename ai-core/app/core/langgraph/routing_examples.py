...
- ``learner``    an active learner in channel 1, no admin role anywhere
- ``authority``  a scrum master of channel 1 (channel authority, not superadmin)
- ``admin``      a superadmin with no channel membership at all
...
ROUTING_EXAMPLES: Tuple[RoutingExample, ...] = (
    ...
    RoutingExample("create channel Backend-01", "authority", (BACK_OFFICE,), "back_office_channel"),
    RoutingExample("open a new channel called Frontend-02", "admin", (BACK_OFFICE,), "back_office_channel"),
    RoutingExample(
        "please set up the channel Data-03 for the March intake", "admin", (BACK_OFFICE,), "back_office_channel"
    ),
    RoutingExample("archive channel Backend-01", "authority", (BACK_OFFICE,), "back_office_channel"),
    RoutingExample(
        "deactivate the channel Frontend-02, the programme ended", "admin", (BACK_OFFICE,), "back_office_channel"
    ),
    RoutingExample("create a channel", "learner", (LEARNER,), "back_office_channel_denied_role"),
    RoutingExample("archive channel Backend-01", "learner", (LEARNER,), "back_office_channel_denied_role"),
    RoutingExample(
        "I want to create a channel for the new intake", "learner", (LEARNER,), "back_office_channel_denied_role"
    ),
    RoutingExample("create channel Backend-01", "anonymous", (LEARNER,), "back_office_channel_denied_role"),
    # ---- role administration -------------------------------------------------------
    ...
    RoutingExample("add @dave to channel Backend-01 as a learner", "authority", (BACK_OFFICE,), "back_office_channel"),
    ...
    RoutingExample("start sprint 3 on Monday for channel Data-03", "admin", (BACK_OFFICE,), "back_office_sprint"),
    ...
    # ---- ceremony scheduling -------------------------------------------------------
    RoutingExample(
        "schedule the standup for tomorrow at 9am for channel Backend-01",
        "authority",
        (BACK_OFFICE,),
    ...
    RoutingExample("schedule a retro for Friday", "learner", (BACK_OFFICE,), "back_office_schedule"),
    RoutingExample("cancel tomorrow's standup", "learner", (BACK_OFFICE,), "back_office_schedule"),
    # ---- calendar reads (open to any member, same route for everyone) --------------
    RoutingExample("when is the next standup?", "learner", (BACK_OFFICE,), "back_office_schedule"),
    RoutingExample("when is the next standup?", "authority", (BACK_OFFICE,), "back_office_schedule"),
    ...
    RoutingExample("is there a retro tomorrow?", "learner", (BACK_OFFICE,), "back_office_schedule"),
    RoutingExample("what time is sprint planning?", "learner", (BACK_OFFICE,), "back_office_schedule"),
    ...
    RoutingExample("remind me about the next standup", "learner", (BACK_OFFICE,), "back_office_schedule"),
    RoutingExample("what ceremonies are scheduled for Backend-01?", "admin", (BACK_OFFICE,), "back_office_schedule"),
    RoutingExample("is the retro cancelled?", "authority", (BACK_OFFICE,), "back_office_schedule"),
    # ---- learner questions ---------------------------------------------------------
    ...
    RoutingExample(
        "According to the uploaded document, how do I configure DuckDB?",
        "learner",
        (LEARNER,),
        "learner_document_or_technical",
    ),
    RoutingExample(
        "How do I use Python to query an embedded database?",
        "learner",
        (LEARNER,),
        "learner_document_or_technical",
    ),
    RoutingExample("What does it say?", "learner", (LEARNER,), "learner_document_or_technical"),
    ...
    RoutingExample("Create a meeting", "authority", (BACK_OFFICE,), "back_office_schedule"),
    ...
    RoutingExample("show me the members of Backend-01", "admin", (LEARNER,), "channel_directory"),
    RoutingExample("who is the scrum master of Backend-01?", "learner", (LEARNER,), "channel_directory"),
    ...
    RoutingExample(
        ...
        note="the sprint mutation is denied, while the ceremony keyword still enters back office",
    ),
    RoutingExample(
        "create channel Growth-01 and make @bob its scrum master",
        "admin",
        (BACK_OFFICE,),
        "back_office_channel",
    ...
    RoutingExample(
        "add @bob to channel Backend-01",
        "authority",
        (BACK_OFFICE,),
        "back_office_channel",
        hard=True,
        note="channel membership is back office; 'team' (Mattermost) is workspace admin",
    ),
    RoutingExample(
