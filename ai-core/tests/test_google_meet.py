...
async def test_ceremony_scheduled_result_includes_meet_link(mock_commit, mock_confirm, mock_prepare):
    # Setup mocks
    start = datetime(2026, 9, 8, 14, 0, tzinfo=timezone.utc)
...
async def test_reminder_message_includes_meet_link(mock_record_sent, mock_org, mock_mm, mock_already):
