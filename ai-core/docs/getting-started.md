...
The fastest way to get running. One command starts the API and PostgreSQL. Long-term memory uses an external Qdrant instance — set `QDRANT_URL` and `QDRANT_API_KEY`.
