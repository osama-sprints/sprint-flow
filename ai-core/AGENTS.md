...
- **Qdrant** (external) for long-term memory storage (mem0ai)
...
- **PostgreSQL** - Relational storage and the LangGraph checkpointer
- **Qdrant** - External vector storage for long-term memory
